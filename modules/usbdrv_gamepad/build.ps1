...
Write-Host ""
Write-Host "Install (dogfood test): copy gamepad.drv.elf + match to L:/usb_drivers/gamepad/"
Write-Host "on the device, then replug the gamepad. '.disabled' file restores"
Write-Host "nothing (no built-in gamepad) on the next plug."
